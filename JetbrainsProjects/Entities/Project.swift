...
struct Project: Codable {
    ...
    let projetPrivate: Bool
    let owner: Owner
    let htmlURL: String
    let projetDescription: String?
    let fork: Bool
    let url: String
    let forksURL: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case projetPrivate = "private"
        case owner
        case htmlURL = "html_url"
        case projetDescription = "description"
        case fork, url
...
enum EventsURL: String, Codable {
    case httpsAPIGithubCOMUsersJetBrainsEventsPrivacy = "https://api.github.com/users/JetBrains/events{/privacy}"
}

enum FollowingURL: String, Codable {
    case httpsAPIGithubCOMUsersJetBrainsFollowingOtherUser = "https://api.github.com/users/JetBrains/following{/other_user}"
}

enum GistsURL: String, Codable {
    case httpsAPIGithubCOMUsersJetBrainsGistsGistID = "https://api.github.com/users/JetBrains/gists{/gist_id}"
}
...
enum OwnerNodeID: String, Codable {
    case mdEyOk9YZ2FuaXphdGlvbjg3ODQzNw = "MDEyOk9yZ2FuaXphdGlvbjg3ODQzNw=="
}

enum StarredURL: String, Codable {
    case httpsAPIGithubCOMUsersJetBrainsStarredOwnerRepo = "https://api.github.com/users/JetBrains/starred{/owner}{/repo}"
}
